...
class CustomDataset(DatasetTemplate):
    ...
    def __getitem__(self, index):
        ...
        if 'annos' in info:
            annos = info['annos']
            annos = common_utils.drop_info_with_name(annos, name='DontCare')#将不训练的类别标签取出来
            gt_names = annos['name']
    ...
    def get_infos(self, class_names, num_workers=4, has_label=True, sample_id_list=None, num_features=4):
        ...
        def process_single_scene(sample_idx):
            ...
            if has_label:
                ...
                #if (not gt_boxes_lidar is None) and gt_boxes_lidar.shape[0] != 0:
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_custom_infos':
        ...
        create_custom_infos(
            ...
            #这里可以修改训练所用数据集
            data_path=ROOT_DIR / 'data' / 'data2024_2_15',
            save_path=ROOT_DIR / 'data' / 'data2024_2_15',
        )
